...
SELECT *FROM livraria
WHERE titulo LIKE '%a%' AND preco BETWEEN 20 AND 40;

#24. Mostre os livros cujo título contenha "de" e a editora seja "Record". 

SELECT *FROM livraria
WHERE titulo LIKE '%de%' AND editora = 'Record';
...
#29. Conte quantos livros não têm "a" no título.
