...
create view mostrarpython as
select nome
from cursos 
where nome = 'python basico';

select * from mostrarpython;

create view mostrarsql as
select nome
from cursos 
where nome = 'SQL Avançado';

select * from mostrarsql;

create view mostrarHTML as
select nome
from cursos 
where nome = 'HTML';

select * from mostrarHTML;